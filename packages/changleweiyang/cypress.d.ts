...
import { VNode, RendererNode, RendererElement, ComponentPublicInstance } from 'vue'
...
declare function tsxMount<V extends {}>(originalComponent: MyVNode, options?: MountingOptions<any> & Record<string, any>): Cypress.Chainable<{
